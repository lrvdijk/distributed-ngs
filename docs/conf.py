...
# -*- coding: utf-8 -*-
#
# Digs documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'digs', 'Digs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Digs', 'Digs Documentation',
     author, 'Digs', 'One line description of project.',
     'Miscellaneous'),
]
